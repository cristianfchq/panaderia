...
class RemoveInventory extends StatefulWidget {
  @override
  _RemoveInventoryState createState() => _RemoveInventoryState();
}

class _RemoveInventoryState extends State<RemoveInventory> {
